...
export default function PageRegister() {
  ...
  return (
    <SlideIn>
      <Box p="2" pb="4rem" w="42rem" maxW="full" m="auto">
        <Card>
          <CardHeader pb={0}>
          ...
          <CardBody>
            <Formiz connect={form} autoForm>
              <Stack spacing="4">
                <HStack>
                  <FieldInput name="first_name" label="First Name" required />
                  <FieldInput name="last_name" label="Last Name" required />
                </HStack>
                <HStack>
                  <FieldInput name="phone" label="Phone number" required />
                  <FieldInput name="address" label="Address" required />
                </HStack>
                <FieldInput name="role" label="Roll" required />
                <FieldInput
                  name="username"
